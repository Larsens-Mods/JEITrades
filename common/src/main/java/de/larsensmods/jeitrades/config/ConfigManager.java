...
public class ConfigManager {
    ...
    private static final File configFile = new File("./config/jeitrades-client.json");
    ...
    private static ClientConfig tryLoadConfig(){
        ...
        try {
            ...
            JEITradesMod.LOG.warn("Unable to load config file. Is it corrupted?");
            return null;
        }
    }
    ...
    private static void writeConfig(){
        ...
        try {
            ...
            JEITradesMod.LOG.error("Unable to write config file.", e);
        }
    }
